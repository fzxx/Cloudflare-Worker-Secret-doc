...
- 🔒 **安全加密**：使用 Base64 编码保护文档内容
- ⏰ **自动销毁**：支持设置访问次数和过期时间
- 📝 **Markdown 支持**：支持 Markdown 格式的文档
...
1. **访问并创建 [Cloudflare](https://www.cloudflare.com) 账号**，Compute - Workers和Pages - 创建 - 创建应用程序，从 Hello World! 开始，名称保持默认或者随意设置，点击部署，然后编辑代码，把原来的代码删除，然后把仓库里 `Worker_Secret_doc.js` 的内容复制并粘贴到代码处，点击部署；
